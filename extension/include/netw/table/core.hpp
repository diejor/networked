...
class Core : public godot::RefCounted {
public:
    enum {
        FLAG_SNAPSHOT = 1 << 0,
        FLAG_REMOVE = 1 << 1,
    ...
    struct FrameHead {
        ...
        static constexpr auto wire = netw::wire::describe(
            netw::wire::field<&FrameHead::table_id>(
                "table_id",
                netw::wire::varuint(2)
            ),
            netw::wire::field<&FrameHead::schema_hash>(
                "schema_hash",
                netw::wire::bits(16)
            ),
            netw::wire::field<&FrameHead::tick>("tick", netw::wire::varuint(5)),
            netw::wire::field<&FrameHead::flags>("flags", netw::wire::bits(8)),
            netw::wire::field<&FrameHead::rows>("rows", netw::wire::varuint(2))
        );
    };

    static godot::Dictionary frame_spec_records();

private:
    struct ColumnShape {
        godot::StringName key;
        int type = netw::SchemaCore::VARIANT;
        int stride = 1;
        godot::Ref<netw::NetwQuantize> quantizer;
        int element_bits = 0;
    };
    ...
    static bool read_frame_routes(
        netw::wire::ReadStream &stream,
        int rows,
        godot::PackedInt64Array &r_routes
    );
...
public:
    godot::Error declare(const godot::RID &table, const SchemaRecord *schema);
    ...
    godot::Ref<netw::NetwQuantize> column_quantizer(
