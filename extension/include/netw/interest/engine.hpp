...
public:
    ...
    bool forget_peer(int64_t peer_id);
    ...
    bool projection_admits(int64_t key, const Decl *decl) const;
    ...
    static bool is_key(int64_t key) {
        return key > 0;
    }
    ...
    godot::PackedInt64Array row_after(int64_t key, const Delta &delta) const;
