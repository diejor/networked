...
Placed place(const Ref<NetwMultiplayerCore> &p_core, Node *p_parent) {
    Placed made;
...
TEST_CASE(
    ...
    core->set_scene_carry_move(carried.callable("carry"));
    ...
    CHECK(opts->get_reason() == NetwMultiplayerCore::scene_move_reason());
