## Steam-backed [LobbyDirectory].
##
## Owns the [SteamWrapper], runs Steam callbacks, and translates Steam lobbies
## into [LobbyDirectory.LobbyInfo] rows.
## [br][br]
...
## Joins the Steam lobby named by [param lobby_id].
##
